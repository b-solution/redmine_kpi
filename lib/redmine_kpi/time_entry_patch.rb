      ...
      base.class_eval do
       safe_attributes 'origin_issue_id'
        before_save do
          ...
          if approval_custom_field.present? && (cf = TimeEntryCustomField.find_by(id: approval_custom_field)) && ( custom_field_value = self.visible_custom_field_values.detect{|cfv| cfv.custom_field_id == cf.id} )
